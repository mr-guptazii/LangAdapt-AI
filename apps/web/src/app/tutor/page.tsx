...
interface ChatMessage {
  ...
  speechMetrics?: SpeechMetrics; pronunciation?: PronunciationInfo | null; isMockVoice?: boolean;
}
  ...
  async function send(text: string, extra?: Partial<ChatMessage>) {
    ...
    try {
      ...
      setMessages((m) => [...m, {
        ...
        recommendedActivity: res.recommended_activity, agentsInvoked: res.agents_invoked,
      }]);
