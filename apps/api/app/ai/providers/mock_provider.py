...
_MOCK_EXERCISE_BANK = {
    ...
    "default": [
        {"question_type": "fill_blank", "prompt": "Complete the sentence: She ______ to work every day.",
         "options": None, "correct_answer": "She goes to work every day.", "explanation": "Generated by the mock provider — configure a real LLM_PROVIDER for fully tailored exercises."},
    ],
}
